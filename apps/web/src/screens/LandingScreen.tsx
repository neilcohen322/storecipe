  ...
  return (
    <View style={[styles.screen, { backgroundColor: theme.colors.canvas }]}>
      <View style={styles.copy}>
        ...
        <Text style={[styles.title, { color: theme.colors.text, fontFamily: theme.type.fontFamily.heading }]}>Your recipes, gathered in one calm place.</Text>
...
const styles = StyleSheet.create({ screen: { flex: 1, alignItems: "center", justifyContent: "center", gap: 32, padding: 24 }, copy: { width: "100%", maxWidth: 520 }, eyebrow: { fontSize: 12, fontWeight: "700", letterSpacing: 1.2 }, title: { fontSize: 40, fontWeight: "700", letterSpacing: -1, marginTop: 12 }, subtitle: { fontSize: 18, lineHeight: 26, marginTop: 12 }, action: { marginTop: 24, alignItems: "flex-start" }, button: { minHeight: 48, borderRadius: 12, justifyContent: "center", paddingHorizontal: 20 }, buttonText: { fontSize: 15, fontWeight: "700" }, note: { fontSize: 13, lineHeight: 19, marginTop: 12 }, error: { fontSize: 14, lineHeight: 20, marginTop: 12 }, preview: { width: "100%", maxWidth: 520, borderWidth: 1, borderRadius: 16, padding: 16, gap: 12 }, previewTitle: { fontSize: 16, fontWeight: "700" }, recipe: { flexDirection: "row", alignItems: "center", gap: 12, borderTopWidth: 1, paddingTop: 12 }, thumbnail: { width: 40, height: 40, borderRadius: 8 } });
